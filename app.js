  ...
  template: `
    <div class="jumbotron">
      <div class="container">
        <h1>{{ $ctrl.greet }}</h1>
          <ul>
            <li><a href="https://iterm2.com/">iterm2</a> - terminal tool</li>
            <li>Brew - used to install node.js<a href="http://yoember.com/nodejs/the-best-way-to-install-node-js/"></a></li>
            <li>Atom / Sublime - text editors<a href="https://atom.io"></a></li>
            <li>Git<a href="https://git-for-windows.github.io/"></a></li>
            <li>Github - repo<a href="https://github.com"></a></li>
            <li>SocialMedia<a href="https://linkedin.com/"></a></li>
          </ul>
      </div>
    </div>
  `
